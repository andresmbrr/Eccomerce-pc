...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleCategoriaNotFound(
    ...
    public ResponseEntity<Object> handleCategoriaAlreadyExists(
    ...
    public ResponseEntity<Object> handleValidation(
        ...
        log.warn("Error de validación en ms-categorias");
    ...
    public ResponseEntity<Object> handleGeneral(
        ...
        log.error("Error interno en ms-categorias", ex);
